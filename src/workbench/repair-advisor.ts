...
export function paAdvisorItems(res: B313Result | null | undefined, findingType?: string | null): AdvisorItem[] {
  ...
  items.push(
    ...
    { title: 'Composite Repair (PCC-2 Part 4):', body: 'ใช้วัสดุห่อหุ้มชนิดไม่ใช่โลหะที่ผ่านการออกแบบทางวิศวกรรม (เช่น Carbon Fiber/Epoxy) กับจุดบกพร่องที่ไม่มีการรั่วไหล เพื่อคืนความสามารถในการรับความดัน — เหมาะกับการเสริมกำลังโดยไม่ใช้ Hot Work', sub: [] },
    { title: 'Welded Repair (PCC-2 Part 2):', body: '', sub: [
    ...
    { title: 'Mechanical Repair (PCC-2 Part 3):', body: 'ใช้ Mechanical Clamp ที่ผ่านการออกแบบทางวิศวกรรม หรือกล่องครอบ (เหมาะเมื่อมีข้อจำกัดด้าน Hot Work หรือการเชื่อม — มักเป็นมาตรการชั่วคราว)', sub: [] },
...
const LEAKING_OVERLAY: FindingAdvisorEntry = {
  ...
  items: [
    ...
    { title: 'Interim Containment (PCC-2 Part 3):', body: 'อาจใช้ Leak Containment Clamp แบบยึดด้วยสลักเกลียวเป็นมาตรการชั่วคราวเท่านั้น โดยต้องออกแบบให้รับความดันออกแบบของท่อได้ ระหว่างรอการซ่อมแซมถาวร', sub: [] },
...
export const REPAIR_ADVISOR_BY_FINDING: Record<string, FindingAdvisorEntry> = {
  ...
  'Dent / Mechanical Damage': {
    ...
    items: [
      ...
      { title: 'Repair Options (PCC-2 Part 2/3):', body: 'การเชื่อมพอกเนื้อ/เจียร Gouge ที่เกี่ยวข้อง (หากตื้นและเป็นไปตามที่มาตรฐานอนุญาต) หรือใช้ Full-Encirclement Sleeve ขึ้นอยู่กับผลการประเมิน FFS', sub: [] },
